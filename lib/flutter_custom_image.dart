...
class _FastImageState extends State<FastImage> with WidgetsBindingObserver {
  ...
  void didChangeDependencies() {
    _updateInvertColors();
    // 为了防止push页面等一些操作触发重新resolveImage我加了些判断，这样
    // 当图片的缓存被清除的时候，并且该页面不可见的时候，图片不会再后台resolve,
    // 参考 https://juejin.im/post/5bbec3d15188255c4322bbee#heading-15
